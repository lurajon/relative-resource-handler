...
/**
 * ResourceProvider implementation for external resources.
 *
 * @author Jakob Korherr
 */
public class ExternalResourceProvider implements ResourceProvider
{

    public URL getUrl(FacesContext facesContext, RelativeResource relativeResource)
    {
        throw new UnsupportedOperationException("getUrl() is not supported for external resources");
    }

    public InputStream getInputStream(FacesContext facesContext, RelativeResource relativeResource) throws IOException
    {
        throw new UnsupportedOperationException("getInputStream() is not supported for external resources");
    }
